...
public class DefaultDivider extends RecyclerView.ItemDecoration {
    ...
    public DefaultDivider(Context context, int orientation, @DrawableRes int resId) {
        this(context, orientation, resId, false);
    }

    public DefaultDivider(Context context, int orientation, @NonNull Drawable divider) {
        this(context, orientation, divider, false);
    }

    public DefaultDivider(Context context, int orientation, @DrawableRes int resId, boolean showFooterDivider) {
        this(context, orientation, ContextCompat.getDrawable(context, resId), showFooterDivider);
    }

    public DefaultDivider(Context context, int orientation, @NonNull Drawable divider, boolean showFooterDivider) {
