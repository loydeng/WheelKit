...
typedef struct AVIOContext {
    ...
    /**
     * PauseOrResume or Resume playback for network streaming protocols - e.g. MMS.
     */
...
/**
 * PauseOrResume and Resume playing - only meaningful if using a network streaming
 * protocol (e.g. MMS).
 *
 * @param h     IO context from which to call the read_pause function pointer
 * @param pause 1 for PauseOrResume, 0 for Resume
 */
