...
#define FF_THREAD_SLICE   2 ///< Decode more than one part of a single frame at once
    ...
    /**
     * Set by the client if its custom GetBuffer() callback can be called
     * synchronously from another thread, which allows faster multithreaded decoding.
     * draw_horiz_band() will be called from other threads regardless of this setting.
     * Ignored if the default GetBuffer() is used.
     * - encoding: Set by user.
     * - decoding: Set by user.
     *
...
typedef struct AVHWAccel {
     ...
     * AVCodecContext.GetBuffer() and deallocated after
 ...
 * and reusing a GetBuffer written for video codecs would probably perform badly
